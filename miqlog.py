...
def log_printer(logfile, send_to):
    try:
        logfile.write("%s\n" % 'Generated by MIQLog https://github.com/pavelzag/MIQLog')
        while 1:
...
def get_log(log_type='None', send_to='None'):
    logs_directory = 'logs'
